...
void core::levels::Level3::LoadLevel() {
	...
	_rotatableElements = {
		Rectangle(Vector2(120, 15), Vector2(150, 19), Drawable::Color::LIGHT_BLUE),
		Rectangle(Vector2(15, 15), Vector2(35, 19), Drawable::Color::LIGHT_BLUE)
	};

	_sensorPos = Vector2(132, 82);
